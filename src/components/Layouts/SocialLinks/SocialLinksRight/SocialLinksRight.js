...
const SocialLinksRight = () => {
  return (
    <div className='left w-10 fixed bottom-0 right-4 z-40 text-[#a8b2d1] hidden md:block'>
      <ul className="flex flex-col m-0 p-0 right-social-links gap-5 items-center">
        <li>
